...
class ExerciseDatasource {
    ...
    fun loadExercises(): List<Exercise> {
        return mutableListOf(
            Exercise(1,R.string.brustUebung1, R.drawable.liegestuetze1_1,"Beschreibung", "Brust"),
            Exercise(2,R.string.brustUebung2, R.drawable.positiveliegestuetze1_1,"Beschreibung", "Brust"),
            Exercise(3,R.string.brustUebung3, R.drawable.negativeliegestuetze1_1,"Beschreibung", "Brust"),
            Exercise(4,R.string.schulterUebung1, R.drawable.seitenhebenkurzhantel,"Beschreibung", "Schulter"),
            Exercise(5,R.string.schulterUebung2, R.drawable.fronthebenkurzhantel1_1,"Beschreibung", "Schulter"),
            Exercise(6,R.string.schulterUebung3, R.drawable.vorgebeugtesseitenheben1_2,"Beschreibung", "Schulter"),
            Exercise(7,R.string.rueckenUebung1, R.drawable.klimmzuege,"Beschreibung", "Rücken"),
            Exercise(8,R.string.rueckenUebung2, R.drawable.rudern,"Beschreibung", "Rücken"),
            Exercise(9,R.string.rueckenUebung3, R.drawable.kreuzheben,"Beschreibung", "Rücken"),
            Exercise(10,R.string.armeUebung1, R.drawable.hammercurls,"Beschreibung", "Arme"),
